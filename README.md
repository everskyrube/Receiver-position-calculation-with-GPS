...
<!-- ABOUT THE PROJECT -->
## About The Project
<p>This work is implemented on MATLAB, and it solely uses raw pseudoranges and satellite ephemeris data as input, to calculate the receiver user position in ECEF, as well as the user clock bias.</p>
...
```
  calSatClockBias.m
```
<p>This function output the satellite clock bias, Delta_t_SV only</p>
